...
namespace WxPaySDK
{
    ...
    public class WxPayData
    {
        ...
        * @throws WxPayException
        */
        public SortedDictionary<string, object> FromXml(WxPayConfig wxPayConfig, string xml)
        {
            ...
            try
            {
                ...
                CheckSign(wxPayConfig, SIGN_TYPE_HMAC_SHA256);//验证签名,不通过会抛异常
            }
        ...
        */
        public string ToJson()
        {
            ...
            string jsonStr = JsonSerializer.Serialize(m_values);
            return jsonStr;
        ...
        */
        public string MakeSign(WxPayConfig wxPayConfig, string signType)
        {
            //转url格式
            string str = ToUrl();
            //在string后加入API KEY
            ...
            {
                return CalcHMACSHA256Hash(str, wxPayConfig.Key);
            }
            else
            {
        ...
        */
        public string MakeSign(WxPayConfig wxPayConfig)
        {
            return MakeSign(wxPayConfig, SIGN_TYPE_HMAC_SHA256);
        }
        ...
        * 正确返回true，错误抛异常
        */
        public bool CheckSign(WxPayConfig wxPayConfig, string signType)
        {
            //如果没有设置签名，则跳过检测
            if (!IsSet("sign"))
            {
