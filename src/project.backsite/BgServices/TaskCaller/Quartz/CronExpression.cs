...
using System.Text;
using project.backsite.BgServices.TaskCaller.Quartz.Collection;
...
namespace project.backsite.BgServices.TaskCaller.Quartz
{
    /// <summary>
    ...
    public class CronExpression : ICloneable, IDeserializationCallback
    {
        ...
        {
            dateUtc = new DateTime(dateUtc.Year, dateUtc.Month, dateUtc.Day, dateUtc.Hour, dateUtc.Minute, dateUtc.Second, DateTimeKind.Utc);
            DateTime test = dateUtc.AddSeconds(-1);

            //new DateTime(dateUtc.Year, dateUtc.Month, dateUtc.Day, dateUtc.Hour, dateUtc.Minute, dateUtc.Second, dateUtc.Millisecond).AddSeconds(-1);
