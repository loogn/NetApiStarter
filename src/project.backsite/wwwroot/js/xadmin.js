...
layui.use(['layer','element','jquery'],function() {
    ...
    //刷新当前
    $('.container .main_reflash i').click(function () {
        var iframe = $("#layui_tab_content .layui-show iframe").get(0);
        (iframe.contentDocument || iframe.contentWindow.document).location.reload();
